...
if __name__ == '__main__':
    ...
    logger.info(f"Best Parameters found from all the runs : {best_parameters_dict}")
    ...
    logger.info("Trained final model with best parameter combination and saved model to S3 bucket")
